        ...
        case "object":
            {
                ...
                if (value instanceof ArrayBuffer) {
                    return "ArrayBuffer [".concat(new Uint8Array(value).toString(), "]");
                }
...
var DataVaultStoreDoesNotExist = createKnownErrorConstructor(KnownError, "DATA_VAULT_STORE_DOES_NOT_EXIST", (storeId)=>[
        400,
        "Data vault store with ID ".concat(storeId, " does not exist."),
        {
            store_id: storeId
        }
    ], (json)=>[
...
var DataVaultStoreHashedKeyDoesNotExist = createKnownErrorConstructor(KnownError, "DATA_VAULT_STORE_HASHED_KEY_DOES_NOT_EXIST", (storeId, hashedKey)=>[
        400,
        "Data vault store with ID ".concat(storeId, " does not contain a key with hash ").concat(hashedKey, "."),
        {
            store_id: storeId,
...
async function getDerivedSymmetricKey(purpose, secret, salt) {
    ...
    return await crypto.subtle.deriveKey({
        ...
        info: new TextEncoder().encode(JSON.stringify([
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$bytes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["encodeBase64"])(salt)
        ]))
    }, originalSecretKey, {
        name: "AES-GCM",
        length: 256
...
async function encrypt(param) {
    let { purpose, secret, value } = param;
...
async function decrypt(param) {
    let { purpose, secret, cipher } = param;
    const version = cipher.slice(0, 2);
    if (version[0] !== 1 || version[1] !== 0) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StackAssertionError"]("Invalid ciphertext version in decrypt(...); expected 0x0100", {
        purpose
    });
    ...
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$results$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Result"].ok(new Uint8Array(plaintext));
    } catch (e) {
        if (e instanceof DOMException && e.name === "OperationError") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$results$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Result"].error(new Error("Invalid ciphertext or secret when decrypting encrypted value", {
                cause: e
            }));
        }
        throw e;
...
async function iteratedHash(options) {
    ...
    const stringOrUint8ArrayToBase64 = (value)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$bytes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["encodeBase64"])(stringOrUint8ArrayToUint8Array(value));
    const input = await crypto.subtle.importKey("raw", stringOrUint8ArrayToUint8Array(options.value), "PBKDF2", false, [
        "deriveBits"
    ]);
    var _options_salt, _options_extra;
    return new Uint8Array(await crypto.subtle.deriveBits({
        name: "PBKDF2",
        salt: new TextEncoder().encode(JSON.stringify([
            "stack-crypto-helper-iterated-hash",
            options.purpose,
            stringOrUint8ArrayToBase64((_options_salt = options.salt) !== null && _options_salt !== void 0 ? _options_salt : ""),
            stringOrUint8ArrayToBase64((_options_extra = options.extra) !== null && _options_extra !== void 0 ? _options_extra : "")
        ])),
...
"[project]/node_modules/@stackframe/stack-shared/dist/esm/helpers/vault/client-side.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getDerivedKey(secret, key) {
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$crypto$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["iteratedHash"])({
...
async function encryptValue(secret, key, value) {
    ...
    const bytes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$crypto$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["encrypt"])({
        purpose: encryptionValuePurpose,
        secret: valueEncryptionDerivedKey,
        value: new TextEncoder().encode(value)
    });
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$bytes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["encodeBase64"])(bytes);
}
async function decryptValue(secret, key, encryptedValue) {
    const valueEncryptionDerivedKey = await getDerivedKey(secret, key);
    const bytesResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$crypto$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decrypt"])({
        purpose: encryptionValuePurpose,
        secret: valueEncryptionDerivedKey,
        cipher: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$bytes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decodeBase64"])(encryptedValue)
    });
...
function decodeAccessTokenIfValid(token) {
    try {
        const payload = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$browser$2f$util$2f$decode_jwt$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decodeJwt"](token);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$schema$2d$fields$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessTokenPayloadSchema"].validateSync(payload);
    } catch (e) {
        return null;
    }
}
var AccessToken = class _AccessToken {
    ...
    get payload() {
        var _decodeAccessTokenIfValid;
        return (_decodeAccessTokenIfValid = decodeAccessTokenIfValid(this.token)) !== null && _decodeAccessTokenIfValid !== void 0 ? _decodeAccessTokenIfValid : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["throwErr"])("Invalid access token in payload (should've been validated in createIfValid)", {
            token: this.token
        });
    }
    get expiresAt() {
...
var InternalSession = class _InternalSession {
   ...
   */ async _getNewlyFetchedAccessToken() {
     ...
     */ this._knownToBeInvalid = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$stores$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Store"](false);
        this._refreshPromise = null;
        this._accessToken = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$stores$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Store"](_options.accessToken ? AccessToken.createIfValid(_options.accessToken) : null);
...
var StackClientInterface = class {
    ...
    async getOAuthProvider(userId, providerId, session) {
        const response = await this.sendClientRequest("/oauth-providers/".concat(userId, "/").concat(providerId), {
            method: "GET"
        }, session);
        return await response.json();
    }
    ...
    async listOAuthProviders() {
        let options = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, session = arguments.length > 1 ? arguments[1] : void 0;
        ...
        const response = await this.sendClientRequest("/oauth-providers".concat(queryParams.toString() ? "?".concat(queryParams.toString()) : ""), {
            method: "GET"
        }, session);
        const result = await response.json();
        return result.items;
    ...
    async getItem(options, session) {
        ...
        if ("userId" in options) {
            ...
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StackAssertionError"]("getItem requires one of userId, teamId, or customCustomerId");
        }
        const response = await this.sendClientRequest((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$urls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["urlString"])(_templateObject1(), customerType, customerId, options.itemId), {}, session);
        return await response.json();
    }
...
var StackServerInterface = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$interface$2f$client$2d$interface$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StackClientInterface"] {
    ...
    async updateItemQuantity(options, data) {
        ...
        if ("userId" in options) {
            ...
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StackAssertionError"]("updateItemQuantity requires one of userId, teamId, or customCustomerId");
        }
        ...
        await this.sendServerRequest("/payments/items/".concat(customerType, "/").concat(customerId, "/").concat(itemId, "/update-quantity?").concat(queryParams.toString()), {
            method: "POST",
            headers: {
                "content-type": "application/json"
            },
    ...
    async getDataVaultStoreValue(secret, storeId, key) {
        const hashedKey = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$helpers$2f$vault$2f$client$2d$side$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hashKey"])(secret, key);
        const response = await this.sendServerRequestAndCatchKnownError("/data-vault/stores/".concat(storeId, "/get"), {
            method: "POST",
            headers: {
                "content-type": "application/json"
            },
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$known$2d$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["KnownErrors"].DataVaultStoreHashedKeyDoesNotExist
        ]);
        if (response.status === "error") {
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$known$2d$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["KnownErrors"].DataVaultStoreHashedKeyDoesNotExist.isInstance(response.error)) {
                return null;
            } else {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StackAssertionError"]("Unexpected uncaught error", {
        ...
        if (typeof encryptedValue !== "string") throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StackAssertionError"]("encrypted_value is not a string", {
            type: typeof encryptedValue
        });
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$helpers$2f$vault$2f$client$2d$side$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decryptValue"])(secret, key, encryptedValue);
    }
    async setDataVaultStoreValue(secret, storeId, key, value) {
        const hashedKey = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$helpers$2f$vault$2f$client$2d$side$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hashKey"])(secret, key);
        const encryptedValue = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$helpers$2f$vault$2f$client$2d$side$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["encryptValue"])(secret, key, value);
        await this.sendServerRequest("/data-vault/stores/".concat(storeId, "/set"), {
            method: "POST",
            headers: {
                "content-type": "application/json"
            },
...
var StackAdminInterface = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$interface$2f$server$2d$interface$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StackServerInterface"] {
    ...
    async sendAdminRequestAndCatchKnownError(path, requestOptions, tokenStoreOrNull, errorsToCatch) {
        try {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$results$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Result"].ok(await this.sendAdminRequest(path, requestOptions, tokenStoreOrNull));
        } catch (e) {
            for (const errorType of errorsToCatch){
                if (errorType.isInstance(e)) {
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$results$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Result"].error(e);
    ...
    async updateEmailDraft(id, data) {
        await this.sendAdminRequest("/internal/email-drafts/".concat(id), {
            method: "PATCH",
            headers: {
                "content-type": "application/json"
            },
    ...
    async getMetrics() {
        ...
        const response = await this.sendAdminRequest("/internal/metrics".concat(queryString ? "?".concat(queryString) : ""), {
            method: "GET"
        }, null);
        return await response.json();
    }
    ...
    async getStripeAccountInfo() {
        const response = await this.sendAdminRequestAndCatchKnownError("/internal/payments/stripe/account-info", {}, null, [
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$known$2d$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["KnownErrors"].StripeAccountInfoNotFound
        ]);
        if (response.status === "error") {
            return null;
        }
    ...
    async listTransactions(params) {
        ...
        if (params === null || params === void 0 ? void 0 : params.cursor) qs.set("cursor", params.cursor);
        if (typeof (params === null || params === void 0 ? void 0 : params.limit) === "number") qs.set("limit", String(params.limit));
        if (params === null || params === void 0 ? void 0 : params.type) qs.set("type", params.type);
        if (params === null || params === void 0 ? void 0 : params.customerType) qs.set("customer_type", params.customerType);
        const response = await this.sendAdminRequest("/internal/payments/transactions".concat(qs.size ? "?".concat(qs.toString()) : ""), {
            method: "GET"
        }, null);
        const json = await response.json();
        return {
...
//# sourceMappingURL=node_modules_%40stackframe_stack-shared_dist_esm_2f9fa9cd._.js.map